...
class piInterface : public RobotInterface
{
public:
  piInterface(const std::string& taskFile, const std::string& urdfFile, const std::string& referenceFile,
                  bool useHardFrictionConeConstraint = false);

  ~piInterface() override = default;
