...
#include "pi_interface/piInterface.h"
#include "pi_interface/piRobotPreComputation.h"
#include "pi_interface/constraint/FrictionConeConstraint.h"
#include "pi_interface/constraint/LeggedSelfCollisionConstraint.h"
#include "pi_interface/constraint/NormalVelocityConstraintCppAd.h"
#include "pi_interface/constraint/XYReferenceConstraintCppAd.h"
#include "pi_interface/constraint/XYLimitConstraint.h"
#include "pi_interface/constraint/ZeroForceConstraint.h"
#include "pi_interface/constraint/ZeroVelocityConstraintCppAd.h"
#include "pi_interface/cost/piRobotQuadraticTrackingCost.h"
#include "pi_interface/initialization/piRobotInitializer.h"
...
#include "pi_interface/constraint/FootRollConstraint.h"
#include <pi_interface/dynamics/piRobotDynamicsAD.h>
...
namespace legged
{
piInterface::piInterface(const std::string& taskFile, const std::string& urdfFile,
  ...
  : useHardFrictionConeConstraint_(useHardFrictionConeConstraint)
{
  ...
  {
    std::cerr << "[piInterface] Loading task file: " << taskFilePath << std::endl;
  }
  else
  {
    throw std::invalid_argument("[piInterface] Task file not found: " + taskFilePath.string());
  }
  ...
  {
    std::cerr << "[piInterface] Loading Pinocchio model from: " << urdfFilePath << std::endl;
  }
  else
  {
    throw std::invalid_argument("[piInterface] URDF file not found: " + urdfFilePath.string());
  }
  ...
  {
    std::cerr << "[piInterface] Loading target command settings from: " << referenceFilePath << std::endl;
  }
  else
  {
    throw std::invalid_argument("[piInterface] targetCommand file not found: " + referenceFilePath.string());
  }
...
/******************************************************************************************************/
/******************************************************************************************************/
void piInterface::setupOptimalControlProblem(const std::string& taskFile, const std::string& urdfFile,
                                                 const std::string& referenceFile, bool verbose)
{
  ...
  dynamicsPtr = std::make_unique<piRobotDynamicsAD>(*pinocchioInterfacePtr_, centroidalModelInfo_, "dynamics",
                                                        modelSettings_);
  ...
  initializerPtr_ =
      std::make_unique<piRobotInitializer>(centroidalModelInfo_, *referenceManagerPtr_, extendNormalizedNomentum);
}
...
piInterface::getSoftSwingTrajConstraint(const EndEffectorKinematics<scalar_t>& eeKinematics,
...
// std::unique_ptr<StateInputConstraint> piInterface::getFootRollConstraint(size_t contactPointIndex){
...
/******************************************************************************************************/
/******************************************************************************************************/
void piInterface::setupModel(const std::string& taskFile, const std::string& urdfFile,
                                 const std::string& referenceFile, bool /*verbose*/)
{
  // PinocchioInterface
...
/******************************************************************************************************/
/******************************************************************************************************/
void piInterface::setupReferenceManager(const std::string& taskFile, const std::string& urdfFile,
                                            const std::string& referenceFile, bool verbose)
{
...
/******************************************************************************************************/
/******************************************************************************************************/
void piInterface::setupPreComputation(const std::string& taskFile, const std::string& urdfFile,
                                          const std::string& referenceFile, bool verbose)
{
  problemPtr_->preComputationPtr =
      std::make_unique<piRobotPreComputation>(*pinocchioInterfacePtr_, centroidalModelInfo_,
...
/******************************************************************************************************/
/******************************************************************************************************/
std::shared_ptr<GaitSchedule> piInterface::loadGaitSchedule(const std::string& file, bool verbose) const
{
...
/******************************************************************************************************/
/******************************************************************************************************/
matrix_t piInterface::initializeInputCostWeight(const std::string& taskFile, const CentroidalModelInfo& info)
{
...
/******************************************************************************************************/
/******************************************************************************************************/
std::unique_ptr<StateInputCost> piInterface::getBaseTrackingCost(const std::string& taskFile,
...
/******************************************************************************************************/
/******************************************************************************************************/
std::unique_ptr<StateInputCost> piInterface::getLimitConstraints(const CentroidalModelInfo& info)
{
  const size_t totalContactDim = 3 * info.numThreeDofContacts + 6 * info.numSixDofContacts;
...
piInterface::loadFrictionConeSettings(const std::string& taskFile, bool verbose)
{
  boost::property_tree::ptree pt;
  boost::property_tree::read_info(taskFile, pt);
...
/******************************************************************************************************/
/******************************************************************************************************/
std::unique_ptr<StateInputConstraint> piInterface::getFrictionConeConstraint(size_t contactPointIndex,
...
/******************************************************************************************************/
/******************************************************************************************************/
std::unique_ptr<StateInputCost> piInterface::getFrictionConeSoftConstraint(
...
piInterface::getEeKinematicsPtr(const std::vector<std::string>& footNames, const std::string& modelName)
{
...
/******************************************************************************************************/
/******************************************************************************************************/
std::unique_ptr<StateInputConstraint> piInterface::getZeroVelocityConstraint(
...
/******************************************************************************************************/
/******************************************************************************************************/
std::unique_ptr<StateCost> piInterface::getSelfCollisionConstraint(const PinocchioInterface& pinocchioInterface,
