...
#include "hi_controllers/SafetyChecker.h"
#include "hi_controllers/visualization/piSelfCollisionVisualization.h"
#include "std_msgs/Float64MultiArray.h"
#include <atomic>
#include "std_msgs/Float32.h"
#include <dynamic_reconfigure/server.h>
#include "hi_controllers/TutorialsConfig.h"
...
{
public:
  hiController() = default;
  ~hiController() override;
...
protected:
  ...
  void dynamicParamCallback(hi_controllers::TutorialsConfig& config, uint32_t level);
  ...
  // Interface
  std::shared_ptr<hiInterface> HiInterface_;
  ...
  // Visualization
  std::shared_ptr<legged::hiRobotVisualizer> robotVisualizer_;
  ...
  std::unique_ptr<dynamic_reconfigure::Server<hi_controllers::TutorialsConfig>> serverPtr_;
