...
#include <pi_common/hardware_interface/ContactSensorInterface.h>
...
#include <pi_estimation/StateEstimateBase.h>
#include <pi_interface/piInterface.h>
#include <pi_wbc/WbcBase.h>
#include "pi_controllers/SafetyChecker.h"
#include "pi_controllers/visualization/piSelfCollisionVisualization.h"
#include "std_msgs/Float64MultiArray.h"
#include <atomic>
#include "std_msgs/Float32.h"
#include <dynamic_reconfigure/server.h>
#include "pi_controllers/TutorialsConfig.h"
...
protected:
  ...
  void dynamicParamCallback(pi_controllers::TutorialsConfig& config, uint32_t level);
  ...
  // Interface
  std::shared_ptr<piInterface> PiInterface_;
  ...
  // Visualization
  std::shared_ptr<legged::piRobotVisualizer> robotVisualizer_;
  std::shared_ptr<piSelfCollisionVisualization> selfCollisionVisualization_;
  ...
  std::unique_ptr<dynamic_reconfigure::Server<pi_controllers::TutorialsConfig>> serverPtr_;
