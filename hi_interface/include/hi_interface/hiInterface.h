...
class hiInterface : public RobotInterface
{
public:
  hiInterface(const std::string& taskFile, const std::string& urdfFile, const std::string& referenceFile,
                  bool useHardFrictionConeConstraint = false);

  ~hiInterface() override = default;
