  ...
  , rbdConversions_(pinocchioInterface, info_)
{
  ...
  SwingPosErrPub_ = nh.advertise<hi_wbc::nvector3f>("SwingPosErrWBC",1);
  SwingVelErrPub_ = nh.advertise<hi_wbc::nvector3f>("SwingVelErrWBC",1);
  SwingKpErrPub_ = nh.advertise<hi_wbc::nvector3f>("SwingKpErrWBC",1);
  SwingKdErrPub_ = nh.advertise<hi_wbc::nvector3f>("SwingKdErrWBC",1);
...
Task WbcBase::formulateSwingLegTask()
{
  ...
  // hi_wbc::nvector3f swing_pos_err_msg,swing_vel_err_msg,swing_kp_err_msg,swing_kd_err_msg;
