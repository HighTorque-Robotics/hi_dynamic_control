  ...
  , rbdConversions_(pinocchioInterface, info_)
{
  ...
  SwingPosErrPub_ = nh.advertise<pi_wbc::nvector3f>("SwingPosErrWBC",1);
  SwingVelErrPub_ = nh.advertise<pi_wbc::nvector3f>("SwingVelErrWBC",1);
  SwingKpErrPub_ = nh.advertise<pi_wbc::nvector3f>("SwingKpErrWBC",1);
  SwingKdErrPub_ = nh.advertise<pi_wbc::nvector3f>("SwingKdErrWBC",1);
...
void WbcBase::pseudoInverse(DMat const& matrix, double sigmaThreshold, DMat& invMatrix) 
{
...
void WbcBase::updateMeasured(const vector_t& rbdStateMeasured)
{
  ...
  qMeasured_.segment<3>(3) = rbdStateMeasured.head<3>();  // yaw pitch roll
...
Task WbcBase::formulateSwingLegTask()
{
  ...
  // pi_wbc::nvector3f swing_pos_err_msg,swing_vel_err_msg,swing_kp_err_msg,swing_kd_err_msg;
